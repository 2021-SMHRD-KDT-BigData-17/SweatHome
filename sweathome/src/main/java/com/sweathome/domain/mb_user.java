...
public class mb_user {
	...
	private String USER_MB_PW; // 유저 비밀번호
	private String USER_MB_NAME; // 유저 이름
	private String USER_PHONE; // 유저 전화번호
	private int USER_HEIGHT; // 유저 키
	private int USER_AGE; // 유저 나이
	private char USER_GENDER; // 유저 성별 (남자:0, 여자:1)
	private int USER_WEIGHT; // 유저 몸무게
	private char USER_PURPOSE; // 유저 운동목적 (다이어트:0, 벌크업:1)
	private char USER_MOMENT; // 유저 활동량 (매우적음:0, 적음:1, 보통:2, 많음:3, 매우 많음:4)
	...
	private char USER_TYPE; // 관리자 구분(일반 사용자:0, 관리자:1)
	...
	public char getUSER_PURPOSE() {
		return USER_PURPOSE;
	}
	public void setUSER_PURPOSE(char uSER_PURPOSE) {
		USER_PURPOSE = uSER_PURPOSE;
	}
	public char getUSER_MOMENT() {
		return USER_MOMENT;
	}
	...
	public mb_user(String uSER_ID, String uSER_MB_PW, String uSER_MB_NAME, String uSER_PHONE, int uSER_HEIGHT,
			int uSER_AGE, char uSER_GENDER, int uSER_WEIGHT, char uSER_PURPOSE, char uSER_MOMENT, int uSER_DIET_DAY,
			int uSER_CALORIES, int uSER_CARBOHYDRATE, int uSER_PROTEIN, int uSER_FAT, int uSER_MOMENT_CALORIES,
			int uSER_ACCU_POINT, int uSER_POINT, String uSER_JOINDATE, char uSER_TYPE) {
		super();
		USER_ID = uSER_ID;
		USER_MB_PW = uSER_MB_PW;
		USER_MB_NAME = uSER_MB_NAME;
	...
	public mb_user(int uSER_CALORIES, int uSER_CARBOHYDRATE, int uSER_PROTEIN, int uSER_FAT, int uSER_MOMENT_CALORIES,
			int uSER_ACCU_POINT, int uSER_POINT, String uSER_JOINDATE, char uSER_TYPE) {
		super();
		USER_CALORIES = uSER_CALORIES;
		USER_CARBOHYDRATE = uSER_CARBOHYDRATE;
